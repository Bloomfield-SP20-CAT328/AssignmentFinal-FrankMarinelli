...
public class Maze_BacktrackingGenerator {
	private byte[,] maze;
	...
	public Maze_BacktrackingGenerator() {}
	...
	public void GenerateMaze(int mazeWidth, int mazeHeight) {
		...
		while(track.Count>0) {
			// 2. Randomly choose a wall at the current cell and open a
			// passage through it to any random, unvisited, adjacent cell.
		...
		// 4. Stop when the algorithm has backed all the way up to the
		// starting cell.
		}
		Debug.Log("DONE!\n" + this.ToString());
	}
